    ...
    async function getCoin(){
      try{
        ...
        .then((data: DataProps) => {
          ...
          const resultData = {
            ...data.data,
            formatedPrice: price.format(parseFloat(data.data.priceUsd)),
            formatedMarket: priceCompact.format(parseFloat(data.data.marketCapUsd)),
            formatedVolume: priceCompact.format(parseFloat(data.data.volumeUsd24Hr))
          }
